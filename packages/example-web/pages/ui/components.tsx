import { ButtonBase, Button, Link, LinkBase, type ButtonTheme } from '@sfpy/styleguide';
  ...
  return (
    <>
      ...
      <DemoTile title="external link with icon">
        <Button href="https://docs.expo.dev" leftSlot={<BookIcon className="icon-lg" />} openInNewTab theme="tertiary">
          Docs
        </Button>
      </DemoTile>
      ...
      <DemoTile title="medium">
        <Button theme="primary-destructive" size="md" leftSlot={<TrashIcon />} />
      </DemoTile>
      <DemoTile title="xs">
      ...
      <DemoTile title="icon with custom color">
        <Button theme="secondary" size="lg" leftSlot={<GemIcon className="text-palette-pink10" />}>
          Subscribe
        </Button>
        <Button
          className="ml-4"
